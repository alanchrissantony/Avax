                    ...
                    <form onSubmit={handleSubmit} className="signupForm">
                        <div className="form mt-5 text-left">
                            ...
                            <div className="password">
                                ...
                                <input className="auth" type="password" name="password" placeholder="Password" required onChange={handlePassword} />
                            </div>
                            <div className="password">
                                <label className="text-xs font-bold" htmlFor="password">Confirm password</label>
                                <input className="auth" type="password" name="confirm_password" placeholder="Confirm password" required onChange={(e) => setConfirmPassword(e.target.value)} />
                            </div>
