        ...
        <section className="md:flex justify-center items-center h-screen">
            <div className="signupSection lg:w-6/12 xl:5/12 m-auto">
                <div className="container sm:10/12 md:w-6/12 grid-cols-1 m-auto text-center pt-10">
                    ...
                    <span className="text-sm">Enter the email address or username linked to your Spotify account and we'll send you an email.</span>
                    <div className="form mt-5 text-left">
                        <div className="email grid-cols-1">
                            ...
                            <input className="auth" type="email" placeholder="Email or username" required/>
                        </div>
                    </div>
                    
                    <button className="signupBtn text-sm font-extrabold">Send OTP</button>
